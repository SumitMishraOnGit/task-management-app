export default function Layout() {
    return (<>
        ...
        <div className="h-screen w-280px flex " >
            <div className="w-[280px] h-screen bg-neutral-900/90 text-white flex flex-col justify-between p-4 ">

                <ul className="mt-16 pl-2 space-y-2">
                    <li className="list-none text-base font-regular py-2 px-5 cursor-pointer hover:bg-neutral-800 hover:rounded-md flex items-center gap-3">
                        <img src="/icons/dashboard.svg" alt="Dashboard" className="w-5 invert h-5" />
                        Dashboard
                    </li>
                    <li className="list-none text-lg py-2 px-5 font-regular cursor-pointer hover:bg-neutral-800 hover:rounded-md flex items-center gap-3">
